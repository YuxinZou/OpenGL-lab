...
int main(int argc, char **argv) {
    ...
    GLFWContext  context(argc, argv,800,600,"Echtzeitcomputergraphik - Aufgabe 8 a");
    ...
    SimpleFileShader hairShader("hairShader",SHADERPATH"hair.vert",SHADERPATH"hair.frag",SHADERPATH"hair_lines.geom");
