...
int main(int argc, char **argv) {
    ...
    GLFWContext  context(argc, argv,800,600,"Echtzeitcomputergraphik - Aufgabe 6 a");
    ...
    SimpleFileShader shader("FileShader",SHADERPATH"simpleTexture.vert",SHADERPATH"simpleTexture.frag");
