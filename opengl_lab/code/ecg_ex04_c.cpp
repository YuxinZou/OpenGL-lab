...
int main(int argc, char **argv) {
    ...
    GLFWContext  context(argc, argv,800,600,"Echtzeitcomputergraphik - Aufgabe 4 c");
...
//     Utils::OBJWavefrontFile objfile(MODELPATH"sphere.obj");
    ...
    //animate the lightsource
    OGLSGRotationalAnimator anim(glm::vec3(0.f,0.f,0.f),glm::vec3(0.f,1.f,0.f),0.01f,&camControler);
    
    OGLLightSource lightSource1(glm::vec3(0.2f,0.2f,0.2f),glm::vec3(0.5f,0.5f,0.0f),glm::vec3(0.7f,0.7f,0.7f),glm::translate(glm::vec3(5.f,0.f,-2.f)),&anim);
